...
export default class LoadingStepManager{
    ...
    constructor(){
        ...
        this.steps[LoadingStepEnum.Res] = new LoadingStepRes(LoadingStepEnum.Res,50,this);
        this.steps[LoadingStepEnum.Scene] = new LoadingStepScene(LoadingStepEnum.Scene,20,this);
