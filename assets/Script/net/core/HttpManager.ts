...
{
    private static _inst:HttpManager;
    public static getInst(){
        return this._inst ||(this._inst=new HttpManager())
    }
    ...
    private quest(option, callback) {
        ...
        xhr.ontimeout = function () {
            ...
            Log.debug('%c连%c接%c超%c时', 'color:red', 'color:orange', 'color:purple', 'color:green');
        };
    };
...
export var HTTP = HttpManager.getInst();