...
export default class BuildPanel extends UIBase{
    ...
    private doShow(cb?:Function){
        ...
        this.topNode.runAction(cc.moveTo(0.3,cc.v2(0,0)).easing(cc.easeInOut(3)));
        this.panelNode.runAction(
            cc.sequence(
                cc.moveTo(0.3,cc.v2(0,0)).easing(cc.easeInOut(3)),
                cc.callFunc(()=>{
    ...
    private doHide(noAction:boolean =false,cb?:Function){
        if(noAction){
            ...
            this.topNode.runAction(cc.moveTo(0.3,cc.v2(750,0)).easing(cc.easeInOut(3)));
            this.panelNode.runAction(cc.moveTo(0.3,cc.v2(0,-1000)).easing(cc.easeInOut(3)))
